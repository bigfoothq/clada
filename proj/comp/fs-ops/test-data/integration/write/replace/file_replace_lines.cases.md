...
```sh sham
#!SHAM [@three-char-SHA-256: re1]
action = "file_write"
path = "/tmp/t_replace-entire-file/small.txt"
content = <<'EOT_SHAM_re1'
Old line 1
Old line 2
Old line 3
EOT_SHAM_re1
...
```sh sham
#!SHAM [@three-char-SHA-256: re2]
action = "file_replace_lines"
path = "/tmp/t_replace-entire-file/small.txt"
lines = "1-3"
new_content = <<'EOT_SHAM_re2'
...
```sh sham
#!SHAM [@three-char-SHA-256: il1]
action = "file_write"
path = "/tmp/t_invalid-line-specification/test.txt"
content = <<'EOT_SHAM_il1'
Line 1
Line 2
Line 3
EOT_SHAM_il1
...
```sh sham
#!SHAM [@three-char-SHA-256: po1]
action = "file_write"
path = "/tmp/t_partial-out-of-range/partial.txt"
content = <<'EOT_SHAM_po1'
Line 1
Line 2
Line 3
EOT_SHAM_po1
...
```sh sham
#!SHAM [@three-char-SHA-256: rv1]
action = "file_write"
path = "/tmp/t_reversed-line-range/reverse.txt"
content = <<'EOT_SHAM_rv1'
Line 1
Line 2
Line 3
EOT_SHAM_rv1
...
```sh sham
#!SHAM [@three-char-SHA-256: zl1]
action = "file_write"
path = "/tmp/t_zero-line-number/test.txt"
content = <<'EOT_SHAM_zl1'
Line 1
Line 2
EOT_SHAM_zl1
#!END_SHAM_zl1
